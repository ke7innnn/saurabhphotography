...
export function Hero() {
  return (
    <section className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden bg-[#E8E3DF]">
      ...
      {/* Overlay Content */}
      <div className="absolute inset-0 z-10 flex flex-col justify-end p-8 md:p-24 bg-gradient-to-t from-black/40 via-transparent to-transparent">
        <motion.div
        ...
        >
          ...
          <motion.div 
            ...
            className="w-24 h-[1px] bg-[#C4A586] origin-left mb-6" 
          />
          <p className="text-white/80 text-lg md:text-xl font-serif italic tracking-wide leading-relaxed max-w-2xl">
