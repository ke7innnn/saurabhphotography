...
export function Hero() {
  return (
    <section className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden bg-[#E8E3DF]">
      ...
      {/* Overlay Content */}
      <div className="absolute inset-0 z-10 flex flex-col justify-end items-end p-8 md:p-24">
        <motion.div
          initial={{ opacity: 0, x: 30 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 1, delay: 1, ease: [0.16, 1, 0.3, 1] }}
          className="max-w-md md:max-w-xl text-right flex flex-col items-end mix-blend-difference"
        >
          ...
          <motion.div 
            ...
            className="w-24 h-[1px] bg-white origin-right mb-6" 
          />
          <p className="text-white text-lg md:text-xl font-serif italic tracking-wide leading-relaxed">
